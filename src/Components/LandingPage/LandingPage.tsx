  ...
  return (
    <section className={className + " " + "landing-page"}>
      ...
      <article>
        ...
        existing code or designs or use new technologies is awesome. From design
        to architecture planning to implementation in both the front and
        backend, I live for this job.
      </article>
